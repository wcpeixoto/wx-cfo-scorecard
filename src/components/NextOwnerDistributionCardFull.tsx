// NextOwnerDistributionCardFull — preserved full chart-version of the Next
// Owner Distribution card (chart, legend, axes, all states). Kept for UI Lab
// reference; the Today surface uses the stripped NextOwnerDistributionCard.
// This is a verbatim copy of the pre-strip card — keep it functional, not a
// static snapshot.
//
...
interface NextOwnerDistributionCardFullProps {
  ownerPayProjection: ScenarioPoint[];
  reserveFloor: number;
}

export function NextOwnerDistributionCardFull({
  ownerPayProjection,
  reserveFloor,
}: NextOwnerDistributionCardFullProps) {
